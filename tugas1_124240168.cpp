...
const int MAX_BOOKS = 100; // maksmial jumlah buku yang terdaftar
...
// fungsi untuk mengurutkan dengan cara Bubblesort
...
// Fungsi untuk mengurutkan dengan cara Quicksort 
...
int main() {
   ...
   switch (choice) {
            case 1: {
                if (count >= MAX_BOOKS) {
                    cout << "Kapasitas buku sudah penuh!\n";
                    break;
                }
